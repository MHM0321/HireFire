  ...
  if (!user) {
    return (
      <SafeAreaView style={styles.container}>
        <Text style={{ color: 'black', padding: 20 }}>Consultant not found.</Text>
      </SafeAreaView>
    );
  }
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView style={styles.contentContainer}>
        <View style={styles.card}>
          ...
          <TouchableOpacity style={styles.button} onPress={() => router.push({ pathname: '/customerPg4C', params: { userId: user.id.toString() } })}>
